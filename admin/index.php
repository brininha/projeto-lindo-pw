...
<head>
    ...
    <!-- Incluindo notícias -->
    <?php
        $consulta2 = $connection->query('SELECT id, titulo, autor, imagem, resumo, texto FROM noticia ORDER BY id DESC');
    ?>
    <!-- Links específicos -->
...
<body>
    ...
    <!-- Cards -->
    <div class="container">
        <h2 class="text-center cards-title">Últimas notícias</h2>
        <p class="text-center cards-text">Veja as nossas últimas boas novas!</p>
        <div class="row row-cols-1 row-cols-md-3 g-4">
            <div class="col">
                <div class="card card-layout">
                    <img src="../images/nova-noticia.png" class="card-img-top">
                    <div class="card-body">
                        <p class="card-text">Crie uma interessantíssima notícia para a plataforma!</p>
                        <a href="./nova-noticia.php" class="btn card-btn">Nova notícia</a>
                    </div>
                </div>
            </div>
            <?php
