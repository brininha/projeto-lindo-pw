...
<head>
    ...
    <?php
        $id = $_GET['id'];
        $consulta2 = $connection->query("SELECT tituloCurso, profCurso, imgCurso, nivelCurso, duracaoCurso, descricaoCurso, numAulasCurso FROM curso WHERE idCurso = $id");
    ...
    <!-- Incluindo aulas -->
    <?php
        $consulta3 = $connection->query("SELECT idAula, tituloAula FROM aula WHERE idCurso = $id");
    ?>
    <!-- Links específicos -->
...
<body>
    ...
    <div class="container mt-5">
        ...
        <div class="uk-slider-container-offset" style="margin: auto" uk-slider>
            <div class="uk-position-relative uk-visible-toggle" tabindex="-1">
                <ul class="uk-slider-items uk-child-width-1-3@s uk-grid">
                    <li>
                        <div class="uk-card uk-card-default card-layout">
                            <div style="height: 200px" class="uk-card-body uk-flex uk-flex-middle uk-flex-center">
                                <a class="btn card-btn" style="color: black" href="./adicionar-aula.php?id=<?=$id?>">
                                Adicionar aula
                                </a>
                            </div>
                        </div>
        ...
        <p class="d-inline-flex gap-1">
            <a href="./excluir-curso.php?id=<?=$id?>" class="btn btn-secondary" role="button">Excluir curso</a>
            <a href="./alterar-curso.php?id=<?=$id?>" class="btn btn-secondary" role="button">Alterar curso</a>
        </p>
    </div>
    <br>
    <!-- Rodapé -->
