...
<head>
    ...
    <?php
        ...
        $num = $_GET['num'];
        $consulta2 = $connection->query("SELECT tituloAula, imgAula, videoAula, textoAula, idCurso FROM aula WHERE idAula = $idAula");
...
<body>
    ...
    <div class="container-xxl mt-5">
        ...
        <br>
        <a href="./concluir-aula.php?idRegistro=<?=$idRegistro?>&idCurso=<?=$idCurso?>&idAula=<?=$idAula?>" class="btn btn-light" role="button">Concluir aula</a>
    </div>
    <br>
    <!-- Rodapé -->
    <?php
