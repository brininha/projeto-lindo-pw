        ...
        <div class="row">
                ...
                <div class="form-box animate__animated animate__fadeInLeft">
                    <form action='./mensagem-contato.php' method='post'>
                        ...
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="input1" placeholder="Nome" name="contato-nome" required autocomplete="off" value="<?=$_SESSION['nome']?>">
                            <label for="input1" class="form-label">Nome</label>
                        </div>
                        <div class="form-floating mb-3">
                            <input type="email" class="form-control" id="input2" placeholder="E-mail" name="contato-email" required autocomplete="off" value="<?=$_SESSION['email']?>">
            ...
            <div class="col">
                <div class="row top-box animate__animated animate__fadeInRight">
                    ...
                    <div class="col-5 uk-flex uk-flex-middle animate__animated animate__pulse animate__infinite animate__slower">
